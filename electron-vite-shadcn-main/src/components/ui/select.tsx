...
interface CustomSelectValueProps extends React.ComponentPropsWithoutRef<"div"> {}

const CustomSelectValue = React.forwardRef<HTMLDivElement, CustomSelectValueProps>(
    ({ children, ...props }, ref) => (
...
// Component without the SelectPrimitive.Portal
